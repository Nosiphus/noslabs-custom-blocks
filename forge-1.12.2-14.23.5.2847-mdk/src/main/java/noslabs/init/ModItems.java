...
public class ModItems {
	...
	public static final Item SUIT_COAT = new ArmorBase("suitcoat", ARMOR_MATERIAL_SUIT, 0, EntityEquipmentSlot.CHEST);
	public static final Item SUIT_PANTS = new ArmorBase("suitpants", ARMOR_MATERIAL_SUIT, 0, EntityEquipmentSlot.LEGS);
	public static final Item SPATTERDASH_SHOES = new ArmorBase("spatterdashshoes", ARMOR_MATERIAL_SUIT, 0, EntityEquipmentSlot.FEET);
	
	public static final Item HARD_HAT = new ArmorBase("hardhat", ARMOR_MATERIAL_CONSTRUCTION, 2, EntityEquipmentSlot.HEAD);
	public static final Item SAFETY_VEST = new ArmorBase("safetyvest", ARMOR_MATERIAL_CONSTRUCTION, 2, EntityEquipmentSlot.CHEST);
	public static final Item SEWER_WADERS = new ArmorBase("sewerwaders", ARMOR_MATERIAL_CONSTRUCTION, 2, EntityEquipmentSlot.LEGS);
	public static final Item STEELTOE_BOOTS = new ArmorBase("steeltoeboots", ARMOR_MATERIAL_CONSTRUCTION , 2, EntityEquipmentSlot.FEET);
			
	public static final Item RIOT_HELMET = new ArmorBase("riothelmet", ARMOR_MATERIAL_RIOT, 3, EntityEquipmentSlot.HEAD);
	public static final Item RIOT_VEST = new ArmorBase("riotvest", ARMOR_MATERIAL_RIOT, 3, EntityEquipmentSlot.CHEST);
	public static final Item RIOT_PANTS = new ArmorBase("riotpants", ARMOR_MATERIAL_RIOT, 3, EntityEquipmentSlot.LEGS);
	public static final Item RIOT_BOOTS = new ArmorBase("riotboots", ARMOR_MATERIAL_RIOT, 3, EntityEquipmentSlot.FEET);
